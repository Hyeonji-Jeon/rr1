    ...
    return (
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="mid" className="block text-sm font-medium text-gray-700">아이디</label>
                        <input
                            id="mid"
                            type="text"
                            value={mid}
                    ...
                    <div>
                        <label htmlFor="mpw" className="block text-sm font-medium text-gray-700">비밀번호</label>
                        <input
                            id="mpw"
                            type="password"
                            value={mpw}
